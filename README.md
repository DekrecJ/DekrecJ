...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .sun { position: absolute; top: 78px; left: 50%; width: 88px; height: 88px; translate: -50% 0; border: 12px solid var(--paper); }
    .pixel-path { position: absolute; bottom: 0; left: 50%; width: 50px; height: 190px; translate: -50% 0; background: var(--ink); clip-path: polygon(42% 0,58% 0,100% 100%,0 100%); }
    ...
    footer { display: grid; grid-template-columns: 1fr auto; align-items: end; gap: 24px; padding: 32px; }
